        ...
        <div id={"reg_id"} className='flex flex-col  bg-middle text-white'>
            ...
            <div className='overflow-hidden w-full  flex flex-col md:flex-row   '>
                ...
                <div className='mt-10  flex flex-col items-center md:items-end w-full '>
                    {closed ?
                        <div className='border-2 border-violet-300 md:mr-80 rounded-md md:mt-60 md:w-2/5 h-fit  w-fit px-10 font-font1 text-xl'>Registration  Closed! People who have submitted the form please check thier email for further procedures 💜  </div> :
